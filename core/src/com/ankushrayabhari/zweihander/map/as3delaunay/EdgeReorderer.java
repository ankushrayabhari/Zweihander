...
public final class EdgeReorderer {
    ...
    private ArrayList<Edge> reorderEdges(ArrayList<Edge> origEdges, Class criterion) {
        ...
        Coordinate firstPoint = (criterion == Vertex.class) ? edge.get_leftVertex() : edge.get_leftSite();
        Coordinate lastPoint = (criterion == Vertex.class) ? edge.get_rightVertex() : edge.get_rightSite();
        ...
        while (nDone < n) {
            for (i = 1; i < n; ++i) {
                ...
                edge = origEdges.get(i);
                Coordinate leftPoint = (criterion == Vertex.class) ? edge.get_leftVertex() : edge.get_leftSite();
                Coordinate rightPoint = (criterion == Vertex.class) ? edge.get_rightVertex() : edge.get_rightSite();
